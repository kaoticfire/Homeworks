...
def save_picture(form_picture: FileStorage) -> str:
    ...
    ;param: form_picture: The filename and path provided in the account form for a user.
    ;return: the filename of the picture to be attached to the users account.
    """
...
def send_reset_email(user: str) -> None:
    ...
    ;param user: the user email for existence to send.
    """
