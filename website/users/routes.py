...
def sign_up():
    ...
    return render_template(
        "sign_up.html", title="Register", form=form, user=current_user
    )
...
def account():
    ...
    img_file = url_for("static", filename="/" + current_user.img_file)
    return render_template(
        "account.html", title="Account", image_file=img_file, form=form
    )
